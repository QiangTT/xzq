...
<!--菜单标题栏开始-->
	<table width='100%' height='31' border='0' cellspacing='0' cellpadding='0' background='${pageContext.request.contextPath}/pages/images/index_26.jpg'>
		<tr>
		<td width='18%'>&nbsp;</td>
		<td width='47%' valign='middle' background='${pageContext.request.contextPath}/pages/images/ctitle_bak_fcenter.jpg'><span class="channel_title">帐务管理<!-- 模块名称 -->></span></td>
	...
	<table width='100%' border='0' cellspacing='0' cellpadding='0'>
		...
		<table width='191' height='31' border='0' cellpadding='0' cellspacing='0' background='${pageContext.request.contextPath}/pages/images/subchannel_bak.jpg'>
      	...
      	<!-- 循环显示操作菜单 -->
			...
			<c:forEach items="${modul
			eList}" var="module">
				<c:if test="${module.name=='帐务管理'}">
...
<table width='100%' height='10%' border='0' cellspacing='0'
	...
	<tr>
		<td width='40'
			background='${pageContext.request.contextPath}/pages/images/index_26.jpg'>
			&nbsp;
		</td>
		<!--内容区导航开始-->
		<td align='left' valign='middle'
			background='${pageContext.request.contextPath}/pages/images/ctitle_bak_center.jpg'>
			<table border='0' cellspacing='0' cellpadding='0'>
				<tr>

					<td height='31'
						background='${pageContext.request.contextPath}/pages/images/ctitle_bak_fcenter.jpg'>
						...
						<a href='index.jsp' class=channel_title>帐务管理首页</a>
						<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
						<a href='${pageContext.request.contextPath}/pages/account/acctmonth.jsp' class=channel_title>帐务管理-月查询</a>
					</td>
				</tr>
			</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<td align="left" height='31'
			background='${pageContext.request.contextPath}/pages/images/ctitle_bak_fcenter.jpg'>
			<form name="accountform" method="post" action="qMonthByYearAndMonth">
			查询条件：&nbsp;&nbsp;		
			年份:<select name="year" style="WIDTH: 80px">
				...
				<option value="2006" ${year==2008?"selected":""}>2006年</option>
			</select>
		...
		<td width="100%" valign="top" >
			...
			<div style="display:block;overflow-x:hidden;overflow-y:auto;height:300px;">
				<table cellspacing='0' cellpadding='0' width="100%" border="1">
					...
					<c:forEach items="${detailmonths}" var="det">
						...
						<tr align="center" class="9P">
							...
							<td width="20%">
								<a
									href="qmonthDetail?ip=${det.labip}&year=${det.year}&month=${det.month}">详细清单</a>
							</td>
						</tr>
					</c:forEach>
				</table>
