...
<head>
	...
	<link href='${pageContext.request.contextPath}/pages/css/main.css'
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<td height='31' background='${pageContext.request.contextPath}/pages/images/ctitle_bak_fcenter.jpg'>
						...
						<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
						<a href='${pageContext.request.contextPath}/pages/account/acctyear.jsp' class=channel_title>帐务管理-年查询</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<form name="accountform" method="post" action="qByYear">
			查询条件：&nbsp;&nbsp;
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<table cellspacing='0' cellpadding='0' width="100%" border="1">
					...
					<c:forEach items="${detailyears}" var="year">
						...
						<tr>
							...
							<td>
								<a href="qMonths?ip=${year.labip}&year=${year.logouttime}">详细清单</a>
						</tr>
					</c:forEach>
