			...
			<table border='0' cellspacing='0' cellpadding='0'>
				<tr>
					...
					<td height='31'
						...
						<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
						<a href='${pageContext.request.contextPath}/pages/account/acctmonthdetail.jsp' class=channel_title>帐务-月明细查询</a>
					</td>
				</tr>
			</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<td align="left" height='31'
			background='${pageContext.request.contextPath}/pages/images/ctitle_bak_fcenter.jpg'>
			实验室IP:
			<input type="text" name="labip" value="192.168.0.23" readonly="readonly" style="WIDTH:80px">
			年:
			<input type="text" name="year" maxlength="20" value="2008" readonly="readonly" style="WIDTH: 80px">
			月:
			<input type="text" name="month" maxlength="20" value="4" readonly="readonly" style="WIDTH: 80px">
		</td>
	</tr>
		...
		<td width="100%" valign="top">
			...
			<div style="display:block;overflow-x:hidden;overflow-y:auto;height:300px;">
				<table cellspacing='0' cellpadding='0' width="100%" border="1">
					...
					<c:forEach items="${detaildaysList}" var="day">
						<tr>
