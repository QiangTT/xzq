	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/user/bussbrforupd.jsp' class=channel_title>业务修改</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<form name="usercondform" method="post" action="../user/bussbrforupd.jsp">
			查询条件：
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<table cellspacing='0' cellpadding='0' width="100%"  border="1">
				<tr class="tabhead">
					<td>业务ID</td><td>用户名</td><td>业务登录名</td><td>状态</td><td>实验室IP</td><td>资费名称</td><td>修改操作</td>
				</tr>
	...
	<tr width="100%"  height="20px">
		<!-- 显示分页导航 -->
		<td>第1页/共1页&nbsp;&nbsp;<a href='${pageContext.request.contextPath}/pages/users/index.do?method=updateBuss&page=1'>|第一页</a>|<a href='${pageContext.request.contextPath}/pages/users/index.do?method=updateBuss&page=1'>上一页</a>|<a href='${pageContext.request.contextPath}/pages/users/index.do?method=updateBuss&page=1'>下一页</a>|<a href='${pageContext.request.contextPath}/pages/users/index.do?method=updateBuss&page=1'>最后一页</a>|</td>
	</tr>
</table>
	</td>
	<!--内容区结束-->
