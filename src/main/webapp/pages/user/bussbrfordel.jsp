      		...
      		<table width='191' height='31' border='0' cellpadding='0' cellspacing='0' background='${pageContext.request.contextPath}/pages/images/subchannel_bak.jpg'>
				...
				<td width='36' height='31' align='right' valign='middle'><img src="${pageContext.request.contextPath}/pages/images/subchannel_doc.jpg" height="9" width="6">&nbsp;</td>
	          	<td align='left' valign='middle'>
	          		<table border='0' cellpadding='0' cellspacing='0'>
	  					<tr>
						<td height='31'><a href='acctbrowse.jsp'>帐务帐号查询</a></td>
						</tr>
					</table>
				</td>
	          	</tr>
      		...
      		<table width='191' height='31' border='0' cellpadding='0' cellspacing='0' background='${pageContext.request.contextPath}/pages/images/subchannel_bak.jpg'>
				...
				<td width='36' height='31' align='right' valign='middle'><img src="${pageContext.request.contextPath}/pages/images/subchannel_doc.jpg" height="9" width="6">&nbsp;</td>
	          	<td align='left' valign='middle'>
	          		<table border='0' cellpadding='0' cellspacing='0'>
	  					<tr>
						<td height='31'><a href='acctadd.jsp'>帐务帐号增加</a></td>
						</tr>
					</table>
				</td>
	          	</tr>
      		...
      		<table width='191' height='31' border='0' cellpadding='0' cellspacing='0' background='${pageContext.request.contextPath}/pages/images/subchannel_bak.jpg'>
				...
				<td width='36' height='31' align='right' valign='middle'><img src="${pageContext.request.contextPath}/pages/images/subchannel_doc.jpg" height="9" width="6">&nbsp;</td>
	          	<td align='left' valign='middle'>
	          		<table border='0' cellpadding='0' cellspacing='0'>
	  					<tr>
						<td height='31'><a href='acctbrforupd.jsp'>帐务帐号修改</a></td>
						</tr>
					</table>
				</td>
	          	</tr>
      		...
      		<table width='191' height='31' border='0' cellpadding='0' cellspacing='0' background='${pageContext.request.contextPath}/pages/images/subchannel_bak.jpg'>
				...
				<td width='36' height='31' align='right' valign='middle'><img src="${pageContext.request.contextPath}/pages/images/subchannel_doc.jpg" height="9" width="6">&nbsp;</td>
	          	<td align='left' valign='middle'>
	          		<table border='0' cellpadding='0' cellspacing='0'>
	  					<tr>
						<td height='31'><a href='acctbrfordel.jsp'>帐务帐号删除</a></td>
						</tr>
					</table>
				</td>
	          	</tr>
      		...
      		<table width='191' height='31' border='0' cellpadding='0' cellspacing='0' background='${pageContext.request.contextPath}/pages/images/subchannel_bak.jpg'>
				...
				<td width='36' height='31' align='right' valign='middle'><img src="${pageContext.request.contextPath}/pages/images/subchannel_doc.jpg" height="9" width="6">&nbsp;</td>
	          	<td align='left' valign='middle'>
	          		<table border='0' cellpadding='0' cellspacing='0'>
	  					<tr>
						<td height='31'><a href='bussbrowse.jsp'>业务帐号查询</a></td>
						</tr>
					</table>
				</td>
	          	</tr>
      		...
      		<table width='191' height='31' border='0' cellpadding='0' cellspacing='0' background='${pageContext.request.contextPath}/pages/images/subchannel_bak.jpg'>
				...
				<td width='36' height='31' align='right' valign='middle'><img src="${pageContext.request.contextPath}/pages/images/subchannel_doc.jpg" height="9" width="6">&nbsp;</td>
	          	<td align='left' valign='middle'>
	          		<table border='0' cellpadding='0' cellspacing='0'>
	  					<tr>
						<td height='31'><a href='bussadd.jsp'>业务帐号增加</a></td>
						</tr>
					</table>
				</td>
	          	</tr>
      		...
      		<table width='191' height='31' border='0' cellpadding='0' cellspacing='0' background='${pageContext.request.contextPath}/pages/images/subchannel_bak.jpg'>
				...
				<td width='36' height='31' align='right' valign='middle'><img src="${pageContext.request.contextPath}/pages/images/subchannel_doc.jpg" height="9" width="6">&nbsp;</td>
	          	<td align='left' valign='middle'>
	          		<table border='0' cellpadding='0' cellspacing='0'>
	  					<tr>
						<td height='31'><a href='bussbrforupd.jsp'>业务帐号修改</a></td>
						</tr>
					</table>
				</td>
	          	</tr>
      		...
      		<table width='191' height='31' border='0' cellpadding='0' cellspacing='0' background='${pageContext.request.contextPath}/pages/images/subchannel_bak.jpg'>
				...
				<td width='36' height='31' align='right' valign='middle'><img src="${pageContext.request.contextPath}/pages/images/subchannel_doc.jpg" height="9" width="6">&nbsp;</td>
	          	<td align='left' valign='middle'>
	          		<table border='0' cellpadding='0' cellspacing='0'>
	  					<tr>
						<td height='31'><a href='${pageContext.request.contextPath}/pages/user/bussbrfordel.jsp'>业务帐号删除</a></td>
						</tr>
					</table>
				</td>
	          	</tr>
      		</table><c:forEach items="${moduleList}" var="module">
	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/user/bussbrfordel.jsp' class=channel_title>业务删除</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<form name="usercondform" method="post" action="../user/bussbrfordel.jsp">
			查询条件：
			用户名称:<input type="text" name="bussusername" value="" style="WIDTH:60px">			
			业务帐号:<input type="text" name="bussloginname" maxlength="20" value="" style="WIDTH: 60px">			
			实验室IP:<input type="text" name="busslabip" maxlength="20" value="" style="WIDTH: 40px">
			状态:<select name="bussstatus" style="WIDTH: 60px"><option value="-1"  selected>全部</option>
						<option value="0" >开通</option>
						<option value="0" >暂停</option></select>			
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<table cellspacing='0' cellpadding='0' width="100%"  border="1">
				<tr class="tabhead">
					<td>业务ID</td><td>用户名</td><td>业务登录名</td><td>状态</td><td>实验室IP</td><td>资费名称</td><td>删除操作</td>
				</tr>
					...
					<tr>
						...
						<td>
							<a href="${pageContext.request.contextPath}/pages/user/bussbrfordel.jsp">删除</a>
						</td>
					</tr>
	...
	<tr width="100%"  height="20px">
		<!-- 显示分页导航 -->
		<td>第1页/共1页&nbsp;&nbsp;<a href='${pageContext.request.contextPath}/pages/users/index.do?method=deleteBuss&page=1'>|第一页</a>|<a href='${pageContext.request.contextPath}/pages/users/index.do?method=deleteBuss&page=1'>上一页</a>|<a href='${pageContext.request.contextPath}/pages/users/index.do?method=deleteBuss&page=1'>下一页</a>|<a href='${pageContext.request.contextPath}/pages/users/index.do?method=deleteBuss&page=1'>最后一页</a>|</td>
	</tr>
</table>
