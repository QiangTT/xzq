	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/user/bussadd.jsp' class=channel_title>业务增加</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<form name="bussform" method="post" action="../user/bussadd.jsp">
			<table border="0"  cellspacing='0' cellpadding='0' width="50%" height="80%">
			<tr>
				<td align="right" valign="top">选择用户：</td>				
				<td align="left" valign="top">
					<!-- 下拉实现 -->
					<select name="userid" style="WIDTH:170px"><option value="1">openlab</option></select>
			...
			<tr>
				...
				<td align="left" valign="top">
					<select name="priceid" style="WIDTH:170px"><option value="1">资费一</option></select>
			...
			<tr>
				...
				<td align="left"  valign="top"><input type="text" name="loginpassword" value="010093" style="WIDTH:170px"></td>
				
			</tr>
			<tr>
				<td align="right" valign="top">实验室IP：</td>
				<td align="left" valign="top"><input type="text" name="labip" value="192.168.0." style="width:170px;"></td>	
			</tr>
			<tr>
