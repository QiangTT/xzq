	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/user/acctadd.jsp' class=channel_title>帐务增加</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<form name="accform" method="post" action="../user/acctadd.jsp">
			...
			<tr>
				...
				<td align="left"  valign="top"><input type="text" name="loginpassword" value="188272" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td colspan="2" align="center">
			...
			<tr>
				...
				<select name="status" style="width:170px;"><option value="0" selected="selected">开通</option>
				   <option value="１">暂停</option></select>
				</td>	
			</tr>
			<tr>
				<td colspan="2" align="center">
			...
			<tr>
				...
				<td align="left" valign="top">
					<select name="sex" style="width:170px;"><option value="0" selected="selected">女</option>
					   <option value="１">男</option></select>
