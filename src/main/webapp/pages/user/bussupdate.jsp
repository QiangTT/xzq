	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>				
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/user/bussupdate.jsp' class=channel_title>业务修改输入</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<form name="bussform" method="post" action="../user/bussupdate.jsp">
			...
			<tr>
				...
				<td align="left" valign="top">
					<input type="text" name="userid" value="openlab" disabled="disabled" style="WIDTH:170px">
				</td>
			</tr>		
			<tr>
			...
			<tr>
				...
				<td align="left"  valign="top"><input type="text" name="loginpassword" value="302404" style="WIDTH:170px"></td>
				
			</tr>
			<tr>
				<td align="right" valign="top">实验室IP：</td>
				<td align="left" valign="top"><input type="text" name="labip" value="192.168.0.23" style="width:170px;"></td>	
			</tr>			
			<tr>
				<td align="right" valign="top">状态：</td>
				<td align="left" valign="top">					
					<select name="status" style="width:170px;"><option value="0" selected>开通</option>
			...
			<tr>
				...
				<td align="left" valign="top">
					<select name="priceid" style="WIDTH:170px"><option value="1" selected>资费一</option></select>
