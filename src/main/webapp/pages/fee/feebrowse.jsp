	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/fee/feebrowse.jsp' class=channel_title>资费浏览</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<form name="feecondform" method="post" action="${pageContext.request.contextPath}/browseFee">
			查询条件：&nbsp;&nbsp;
			资费名称:<input type="text" name="name" value="${condition.name}" style="WIDTH:60px">
			基费范围:<input type="text" name="minbasefee" maxlength="20" value="${condition.minbasefee}" style="WIDTH: 30px">
			-<input type="text" name="maxbasefee" value="${condition.maxbasefee}" style="WIDTH:30px">
			月租费范围:<input type="text" name="minratefee" maxlength="20" value="${condition.minratefee}" style="WIDTH: 30px">
			-<input type="text" name="maxratefee" value="${condition.maxratefee}" style="WIDTH:30px">
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<table cellspacing='0' cellpadding='0' width="100%"  border="1">
				...
				<c:forEach items="${priceAll}" var="pri">
					<tr>
						<td>
							${pri.id}
						</td>
	...
	<tr width="100%"  height="20px">
		...
		<td>第${pageInfo.pageNum}页/共${pageInfo.pages}页
			&nbsp;&nbsp;
			<a href='${pageContext.request.contextPath}/browseFee?pn=${pageInfo.firstPage}&name=${condition.name}&minbasefee=${condition.minbasefee}&maxbasefee=${condition.maxbasefee}&minratefee=${condition.minratefee}&maxratefee=${condition.maxratefee}'>|第一页</a>

			|<a href='${pageContext.request.contextPath}/browseFee?pn=${pageInfo.prePage}&name=${condition.name}&minbasefee=${condition.minbasefee}&maxbasefee=${condition.maxbasefee}&minratefee=${condition.minratefee}&maxratefee=${condition.maxratefee}'>上一页</a>

			|<a href='${pageContext.request.contextPath}/browseFee?pn=${pageInfo.nextPage}&name=${condition.name}&minbasefee=${condition.minbasefee}&maxbasefee=${condition.maxbasefee}&minratefee=${condition.minratefee}&maxratefee=${condition.maxratefee}'>下一页</a>

			|<a href='${pageContext.request.contextPath}/browseFee?pn=${pageInfo.lastPage}&name=${condition.name}&minbasefee=${condition.minbasefee}&maxbasefee=${condition.maxbasefee}&minratefee=${condition.minratefee}&maxratefee=${condition.maxratefee}'>最后一页</a>
			|
		</td>
	</tr>
</table>
