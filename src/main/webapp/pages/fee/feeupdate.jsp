	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/fee/feeupdate.jsp' class=channel_title>资费修改输入</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<form name="feeform" method="post" action="${pageContext.request.contextPath}/updatetimeFee">
			<table border="0"  cellspacing='0' cellpadding='0' width="50%" height="80%">
			<tr>
				<td align="right" valign="top">资费ID：</td>
				<td align="left" valign="top"><input type="text" name="id" value="${detail.id}" readonly="readonly" style="WIDTH:170px"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left" valign="top"><input type="text" name="name" value="${detail.name}" style="WIDTH:170px"></td>
			</tr>
			<tr>
			<td colspan="2" align="center"></td>
			</tr>
			<tr>
				<td align="right" valign="top">小时费用：</td>
				<td align="left" valign="top"><input type="text" name="basefee" value="${detail.basefee}" style="WIDTH:170px"></td>
			</tr>
			<tr>
			<td colspan="2" align="center"></td>
			</tr>
			<tr>
				<td align="right" valign="top">月租费用：</td>				
				<td align="left"  valign="top"><input type="text" name="ratefee" value="${detail.ratefee}" style="WIDTH:170px"></td>
			</tr>
			
			<tr>
				<td align="right" valign="top">资费描述：</td>
				<td align="left" valign="top"><textarea name="description" style="width:170px;height:170px;"></textarea></td>	
			</tr>
			<tr>
