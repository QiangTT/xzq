		...
		<table width='100%' border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<a href="${pageContext.request.contextPath}/pages/main.jsp" class="cl">首页</a><span class="STYLE4">|</span>
					...
					<a href="${pageContext.request.contextPath}/pages/index.jsp" class="cl">退出</a><span class="STYLE4">|</span>
  				</td>
      		</tr>
    	</table>
    	</td>
...
<!--菜单标题栏开始-->
	<table width='100%' height='31' border='0' cellspacing='0' cellpadding='0' background='${pageContext.request.contextPath}/pages/images/index_26.jpg'>
		<tr>
		<td width='18%'>&nbsp;</td>
		<td width='47%' valign='middle' background='${pageContext.request.contextPath}/pages/images/ctitle_bak_fcenter.jpg'><span class="channel_title">资费管理<!-- 模块名称 -->></span></td>
			...
			<td width='36' height='31' align='right' valign='middle'><img src="${pageContext.request.contextPath}/pages/images/subchannel_doc.jpg" height="9" width="6">&nbsp;</td>
          	<td align='left' valign='middle'>
          		<table border='0' cellpadding='0' cellspacing='0'>
  					<tr>
					<td height='31'><a href='${pageContext.request.contextPath}/pages/fee/index.jsp'>首页</a></td>
					</tr>
				</table>
			</td>
          	</tr>
	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<a href='index.jsp' class=channel_title>资费管理首页</a>
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/fee/feebrforupd.jsp' class=channel_title>资费修改</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<form name="feecondform" method="post" action="${pageContext.request.contextPath}/updatetimeFee">
			查询条件：&nbsp;&nbsp;
			资费名称:<input type="text" name="name" value="" style="WIDTH:60px">			
			基费范围:<input type="text" name="minbasefee" maxlength="20" value="" style="WIDTH: 30px">
			-<input type="text" name="maxbasefee" value="" style="WIDTH:30px">
			月租费范围:<input type="text" name="minratefee" maxlength="20" value="" style="WIDTH: 30px">
			-<input type="text" name="maxratefee" value="" style="WIDTH:30px">
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<table cellspacing='0' cellpadding='0' width="100%"  border="1">
				<tr class="tabhead">
					<td>资费ID</td><td>资费名称</td><td>小时费用</td><td>月租费用</td><td>资费说明</td><td>修改操作</td>
				</tr>
				<c:forEach items="${priceAllup}" var="priup">
					<tr>
						<td>
								${priup.id}
						</td>
						...
						<td>
							<a href="${pageContext.request.contextPath}/detail?id=${priup.id}">修改</a>
						</td>
					</tr>
				</c:forEach>
			</table>
	...
	<tr width="100%"  height="20px">
		<!-- 显示分页导航 -->
		<td>第${pageInfo.pageNum}页/共${pageInfo.pages}页&nbsp;&nbsp;
            <a href='${pageContext.request.contextPath}/updatetimeFee?pn=${pageInfo.firstPage}&name=${condition.name}&minbasefee=${condition.minbasefee}&maxbasefee=${condition.maxbasefee}&minratefee=${condition.minratefee}&maxratefee=${condition.maxratefee}'>|第一页</a>

            |<a href='${pageContext.request.contextPath}/updatetimeFee?pn=${pageInfo.prePage}&name=${condition.name}&minbasefee=${condition.minbasefee}&maxbasefee=${condition.maxbasefee}&minratefee=${condition.minratefee}&maxratefee=${condition.maxratefee}'>上一页</a>

            |<a href='${pageContext.request.contextPath}/updatetimeFee?pn=${pageInfo.nextPage}&name=${condition.name}&minbasefee=${condition.minbasefee}&maxbasefee=${condition.maxbasefee}&minratefee=${condition.minratefee}&maxratefee=${condition.maxratefee}'>下一页</a>

            |<a href='${pageContext.request.contextPath}/updatetimeFee?pn=${pageInfo.lastPage}&name=${condition.name}&minbasefee=${condition.minbasefee}&maxbasefee=${condition.maxbasefee}&minratefee=${condition.minratefee}&maxratefee=${condition.maxratefee}'>最后一页</a>
            |
        </td>
	</tr>
</table>
