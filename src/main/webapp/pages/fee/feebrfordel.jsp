	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/fee/feebrfordel.jsp' class=channel_title>资费删除</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<form name="feecondform" method="post" action="${pageContext.request.contextPath}/deleteFee">
			查询条件：&nbsp;&nbsp;
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<table cellspacing='0' cellpadding='0' width="100%"  border="1">
				...
				<c:forEach items="${priceAlldel}" var="pridel">
				<tr>
					<td>
							${pridel.id}
					</td>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/deleteFee?id=${pridel.id}"
	...
	<tr width="100%"  height="20px">
		...
		<td>第${pageInfo.pageNum}页/共${pageInfo.pages}页&nbsp;&nbsp;
            <a href='${pageContext.request.contextPath}/deleteFee?pn=${pageInfo.firstPage}&name=${condition.name}&minbasefee=${condition.minbasefee}&maxbasefee=${condition.maxbasefee}&minratefee=${condition.minratefee}&maxratefee=${condition.maxratefee}'>|第一页</a>

            |<a href='${pageContext.request.contextPath}/deleteFee?pn=${pageInfo.prePage}&name=${condition.name}&minbasefee=${condition.minbasefee}&maxbasefee=${condition.maxbasefee}&minratefee=${condition.minratefee}&maxratefee=${condition.maxratefee}'>上一页</a>

            |<a href='${pageContext.request.contextPath}/deleteFee?pn=${pageInfo.nextPage}&name=${condition.name}&minbasefee=${condition.minbasefee}&maxbasefee=${condition.maxbasefee}&minratefee=${condition.minratefee}&maxratefee=${condition.maxratefee}'>下一页</a>

            |<a href='${pageContext.request.contextPath}/deleteFee?pn=${pageInfo.lastPage}&name=${condition.name}&minbasefee=${condition.minbasefee}&maxbasefee=${condition.maxbasefee}&minratefee=${condition.minratefee}&maxratefee=${condition.maxratefee}'>最后一页</a>
            |
        </td>
	</tr>
</table>
