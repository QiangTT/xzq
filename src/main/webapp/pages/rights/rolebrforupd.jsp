				...
				<table width='100%' border='1' cellspacing='0' cellpadding='0'>
					<tr width="100%" height="10%">
						...
						<td align="left" height='31' background='${pageContext.request.contextPath}/pages/images/ctitle_bak_fcenter.jpg'>
							<form name="rolecond" method="post" action="${pageContext.request.contextPath}/updatetimeRole">
								查询条件：&nbsp;&nbsp;
						...
						<td width="100%" valign="top">
							...
							<div style="overflow:auto;">
								<table cellspacing='0' cellpadding='0' width="100%"  border="1">
									<tr class="tabhead">
										<td>角色ID</td><td>角色名称</td><td>角色拥有的权限[权限名 | 权限URL | 模块名 | 操作名 ]</td><td>修改操作</td>
									</tr>
									...
									<c:forEach items="${map.roleList}" var="role">
										<tr>
											...
											<td>
												<a href="${pageContext.request.contextPath}/role/showUpdate?roleId=${role.id}">
													修改
												</a>
											</td>
										</tr>
					...
					<tr width="100%"  height="20px">
						<!-- 显示分页导航 -->
						<td>第${map.pageSupport.pageNo}页/共${map.pageSupport.totalPage}页&nbsp;&nbsp;<c:if test="${map.pageSupport.pageNo>1}"><a href='${pageContext.request.contextPath}/updatetimeRole?pageNo=1&roleName=${condition.roleName}'>|第一页</a>|<a href='${pageContext.request.contextPath}/updatetimeRole?pageNo=${map.pageSupport.pageNo-1}&roleName=${condition.roleName}'>上一页</a></c:if>|<c:if test="${map.pageSupport.pageNo<map.pageSupport.totalPage}"><a href='${pageContext.request.contextPath}/updatetimeRole?pageNo=${map.pageSupport.pageNo+1}&roleName=${condition.roleName}'>下一页</a>|<a href='${pageContext.request.contextPath}/updatetimeRole?pageNo=${map.pageSupport.totalPage}&roleName=${condition.roleName}'>最后一页</a>|</c:if></td>
					</tr>
				</table>
