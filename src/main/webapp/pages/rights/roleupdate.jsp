	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='rolebrforupd.jsp' class=channel_title>角色修改</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<form name="roleform" method="post" action="${pageContext.request.contextPath}/role/update">
			<table border="0"  cellspacing='0' cellpadding='0' width="80%" height="200">
			<tr>
				<td>角色ID：</td>
				<td align="left"><input type="text" name="id" value="${map.role.id}" readonly="readonly" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td>角色名称：</td>
				<td align="left"><input type="text" name="name" value="${map.role.name}" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td valign="top">拥有权限：</td>
				<td align="left">
					<div style="display:block;overflow-y:scroll;overflow-x:auto;height:280px;">
						<c:forEach items="${map.rightList}" var="right1">
							<input type="checkbox" name="rightIds" value="${right1.id}"
								<c:forEach items="${map.role.rightsList}" var="right">
									<c:if test="${right.id==right1.id}">checked="checked"</c:if>
								</c:forEach> >

							${right1.name}|${right1.module.name} | ${right1.operation.name}
							<br/>
						</c:forEach>
					</div>
				</td>
