...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<form name="roleform" method="post" action="${pageContext.request.contextPath}/role/add">
				...
				<td align="left">
					<div style="display:block;overflow-y:scroll;overflow-x:auto;height:280px;">						
						...
						<c:forEach items="${rightList}" var="right">
                            <input type="checkbox" name="rightIds" value="${right.id}">
                            ${right.name}|${right.module.name} | ${right.operation.name}
                            <br/>
                        </c:forEach>
