	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/rights/rightupdate.jsp' class=channel_title>权限修改</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<form name="rightform" method="post" action="${pageContext.request.contextPath}/right/update">
			<table border="0"  cellspacing='0' cellpadding='0' width="50%" height="80%">
			<tr>
				<td>权限ID：</td>
				<td align="left"><input type="text" name="id" value="${map.right.id}" readonly="readonly" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td>权限名称：</td>
				<td align="left"><input type="text" name="name" value="${map.right.name}" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td>权限 url：</td>
				<td align="left"><input type="text" name="url" value="${map.right.url}" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td>模块名称：</td>
				<td align="left">
					<select name="module.id" style="WIDTH:170px">
						<c:forEach items="${map.moduleList}" var="module">
			...
			<tr>
				<td>操作名称：</td>
				<td align="left">
					<select name="operation.id" size="1" style="WIDTH:170px">
						<c:forEach items="${map.operationList}" var="operation">
			...
			<input type="hidden" value="${condition.pageNo}" name="pageNo">
			<input type="hidden" value="${condition.moduleName}" name="moduleName">
			<input type="hidden" value="${condition.operationName}" name="operationName">
		</form>
