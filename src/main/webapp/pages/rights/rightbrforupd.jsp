							...
							<table border='0' cellspacing='0' cellpadding='0'>
								<tr>
									...
									<td height='31' background='${pageContext.request.contextPath}/pages/images/ctitle_bak_fcenter.jpg'>
										...
										<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
										<a href='${pageContext.request.contextPath}/pages/rights/rightbrowse.jsp' class=channel_title>权限浏览</a>
									</td>
								</tr>
							</table>
						</td>
				...
				<table width='100%' border='1' cellspacing='0' cellpadding='0'>
					<tr width="100%" height="10%">
						...
						<td align="left" height='31' background='${pageContext.request.contextPath}/pages/images/ctitle_bak_fcenter.jpg'>
							<form name="rolecond" method="post" action="${pageContext.request.contextPath}/updatetimeRight?pageNo=1">
								查询条件：&nbsp;&nbsp;
								模块名称:<input type="text" name="moduleName" value="${condition.moduleName}" style="WIDTH:100px">
								权限名称:<input type="text" name="operationName" maxlength="20" value="${condition.operationName}" style="WIDTH: 100px">
						...
						<td width="100%" valign="top">
							...
							<div style="overflow:auto;">
								<table cellspacing='0' cellpadding='0' width="100%"  border="1">
									<tr class="tabhead">
										<td>权限ID</td><td>权限名称</td><td>权限URL</td><td>权限所在模块</td><td>权限操作名称</td><td>修改操作</td>
									</tr>
									<c:forEach items="${rightList}" var="right">
										<tr>
											...
											<td class="update">
												<a href="${pageContext.request.contextPath}/right/detail?pageNo=${pageSupport.pageNo}&moduleName=${condition.moduleName}&id=${right.id}&operationName=${condition.operationName}">修改</a>
											</td>
										</tr>
									</c:forEach>
								</table>
					...
					<tr width="100%"  height="20px">
						<!-- 显示分页导航 -->
						<td>第${pageSupport.pageNo}页/共${pageSupport.totalPage}页&nbsp;&nbsp;<a href='${pageContext.request.contextPath}/updatetimeRight?pageNo=1&moduleName=${condition.moduleName}&operationName=${condition.operationName}'>|第一页</a>|<c:if test="${pageSupport.pageNo>1}"><a href="${pageContext.request.contextPath}/updatetimeRight?pageNo=${pageSupport.pageNo-1}&moduleName=${condition.moduleName}&operationName=${condition.operationName}">上一页</a></c:if><c:if test="${pageSupport.pageNo<pageSupport.totalPage}" ><a href='${pageContext.request.contextPath}/updatetimeRight?pageNo=${pageSupport.pageNo+1}&moduleName=${condition.moduleName}&operationName=${condition.operationName}'>下一页</a></c:if>|<a href='${pageContext.request.contextPath}/updatetimeRight?pageNo=${pageSupport.totalPage}&moduleName=${condition.moduleName}&operationName=${condition.operationName}'>最后一页</a>|</td>
					</tr>
				</table>
