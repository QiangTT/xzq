	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/reckon/reckondetail.jsp' class=channel_title>帐单查询</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<td align="left" height='31' background='${pageContext.request.contextPath}/pages/images/ctitle_bak_fcenter.jpg'>
			帐务帐号:<input type="text" name="accloginname" maxlength="20" value="openlab" readonly="readonly" style="WIDTH: 80px">			
			总费用:<input type="text" name="feetitle" maxlength="20" value="13.71" readonly="readonly" style="WIDTH: 80px">	
		</td>
	</tr>
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<table cellspacing='0' cellpadding='0' width="100%"  border="1">
				<tr class="tabhead">
					<td>业务帐号</td><td>实验室IP</td><td>登录时间</td><td>时长(小时)</td><td>资费</td><td>月租</td><td>费用</td>
				</tr>

                <c:forEach items="${usersbusinesses}" var="billDetail">
                    <tr align="center">
                        <td >${billDetail.loginname}</td>
                        <td >${billDetail.labip}</td>
                        <td >${billDetail.LOGINDATETIME}</td>
                        <td >${billDetail.time}</td>
                        <td >${billDetail.feeName}</td>
                        <td >${billDetail.baseFee}</td>
                        <td >${billDetail.totalFee}</td>
                    </tr>
                </c:forEach>
		</table>
		</div>
	...
	<tr width="100%"  height="20px">
		<!-- 显示分页导航 -->
		<td>第${pag.pageNum}页/共${pag.pages}页&nbsp;&nbsp;<a href='${pageContext.request.contextPath}/detail??page=${pag.firstPage}&id=${Usersbusiness.id}'>|第一页</a>|<a href='${pageContext.request.contextPath}/detail??page=${pag.prePage}&id=${Usersbusiness.id}'>上一页</a>|<a href='${pageContext.request.contextPath}/detail??page=${pag.nextPage}&id=${Usersbusiness.id}'>下一页</a>|<a href='${pageContext.request.contextPath}/detail??page=${pag.lastPage}&id=${Usersbusiness.id}'>最后一页</a>|</td>
	</tr>
</table>
