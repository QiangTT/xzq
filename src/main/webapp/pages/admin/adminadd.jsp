	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/admin/adminadd.jsp' class=channel_title>管理员增加</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<form name="adminform" method="post" action="../admin/adminadd.jsp">
			<table border="0"  cellspacing='0' cellpadding='0' width="80%" height="100%">
			<tr>
				<td align="right">管理员姓名：</td>
				<td align="left"><input type="text" name="name" value="" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td align="right">帐号名：</td>
				<td align="left"><input type="text" name="loginname" value="" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td align="right">口令：</td>
				<td align="left"><input type="text" name="loginpassword" value="" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td align="right">确认口令：</td>
				<td align="left"><input type="text" name="passwordsec" value="" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td align="right">电子邮件：</td>
				<td align="left"><input type="text" name="email" value="" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td align="right">电话：</td>
				<td align="left"><input type="text" name="phone" value="" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td align="right">选择角色：</td>
				<td align="left">
					<div style="display:block;overflow-y:scroll;overflow-x:auto;height:120px;width:200px;background-color:#eeeeee;">						
						
							<input type="checkbox" name="roleid" value="1">
							超级管理员<br>
