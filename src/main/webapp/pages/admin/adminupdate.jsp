	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/admin/adminupdate.jsp' class=channel_title>管理员修改</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<form name="adminform" method="post" action="../admin/adminupdate.jsp">
			<table border="0"  cellspacing='0' cellpadding='0' width="80%" height="100%">
			<tr>
				<td align="right">管理员ID：</td>
				<td align="left"><input type="text" name="id" value="1" readonly="readonly" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td align="right">管理员姓名：</td>
				<td align="left"><input type="text" name="name" value="admin" style="WIDTH:170px"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td align="left"><input type="text" name="email" value="admin@tarena.com.cn" style="WIDTH:170px"></td>
			</tr>
			<tr>
				<td align="right">电话：</td>
				<td align="left"><input type="text" name="phone" value="62135687" style="WIDTH:170px"></td>
			</tr>
			<tr>
				...
				<td align="left">
					<div style="display:block;overflow-y:scroll;overflow-x:auto;height:120px;width:200px;background-color:#eeeeee;">						
							...
							<input type="checkbox" name="roleid" value="1" checked="checked">
							超级管理员<br/>
