	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/admin/adminbrforupd.jsp' class=channel_title>管理员修改</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<form name="admincondform" method="post" action="../admin/adminbrforupd.jsp">
			查询条件：&nbsp;&nbsp;
			...
			-<input type="text" name="dateto" maxlength="20" value="2008-12-12 12:33:27" style="WIDTH: 60px">
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<table cellspacing='0' cellpadding='0' width="100%"  border="1">
				<tr class="tabhead">
					<td>管理员ID</td><td>姓名</td><td>登录名</td><td>电话</td><td>电子邮件</td><td>拥有的角色</td><td>修改操作</td>
				</tr>
	...
	<tr width="100%"  height="20px">
		<!-- 显示分页导航 -->
		<td>第1页/共1页&nbsp;&nbsp;<a href='${pageContext.request.contextPath}/pages/admins/index.do?method=updateAdmin&page=1'>|第一页</a>|<a href='${pageContext.request.contextPath}/pages/admins/index.do?method=updateAdmin&page=1'>上一页</a>|<a href='${pageContext.request.contextPath}/pages/admins/index.do?method=updateAdmin&page=1'>下一页</a>|<a href='${pageContext.request.contextPath}/pages/admins/index.do?method=updateAdmin&page=1'>最后一页</a>|</td>
	</tr>
</table>
