...
<head>
	...
	<title>电信运营计费管理系统-超级管理员修改</title>
	<style type="text/css">
	<!--
	body {
		margin-left: 0px;
	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/admin/adminsuperupd.jsp' class=channel_title>超级管理员修改</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="300px">
		...
		<form name="adminform" method="post" action="../admin/adminsuperupd.jsp">
