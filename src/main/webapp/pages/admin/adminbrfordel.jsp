...
<!--菜单标题栏开始-->
	<table width='100%' height='31' border='0' cellspacing='0' cellpadding='0' background='${pageContext.request.contextPath}/pages/images/index_26.jpg'>
		<tr>
		<td width='18%'>&nbsp;</td>
		<td width='47%' valign='middle' background='${pageContext.request.contextPath}/pages/images/ctitle_bak_fcenter.jpg'><span class="channel_title">管理员管理<!-- 模块名称 -->></span></td>
	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<a href='index.jsp' class=channel_title>管理员管理首页</a>
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/admin/adminbrfordel.jsp' class=channel_title>管理员删除</a>
				</td>
			</tr>
		</table>
		</td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0'>
	<tr width="100%" height="10%">
		...
		<form name="admincondform" method="post" action="../admin/adminbrfordel.jsp">
			查询条件：&nbsp;&nbsp;
			姓名:<input type="text" name="name" value="" style="WIDTH:60px">
			登录名:<input type="text" name="loginname" maxlength="20" value="" style="WIDTH: 80px">			
			授权日期:<input type="text" name="datefrom" maxlength="20" value="1970-01-01 00:00:01" style="WIDTH: 60px">
			-<input type="text" name="dateto" maxlength="20" value="2008-12-12 12:33:38" style="WIDTH: 60px">
	...
	<tr width="100%" height="300px">
		<td width="100%" valign="top">
			...
			<table cellspacing='0' cellpadding='0' width="100%"  border="1">
				<tr class="tabhead">
					<td>管理员ID</td><td>姓名</td><td>登录名</td><td>电话</td><td>电子邮件</td><td>拥有的角色</td><td>删除操作</td>
				</tr>
					...
					<tr>
						...
						<td>
							<a href="${pageContext.request.contextPath}/pages/admin/adminbrfordel.jsp">删除</a>
						</td>
					</tr>
	...
	<tr width="100%"  height="20px">
		<!-- 显示分页导航 -->
		<td>第1页/共1页&nbsp;&nbsp;<a href='${pageContext.request.contextPath}/pages/admins/index.do?method=deleteAdmin&page=1'>|第一页</a>|<a href='${pageContext.request.contextPath}/pages/admins/index.do?method=deleteAdmin&page=1'>上一页</a>|<a href='${pageContext.request.contextPath}/pages/admins/index.do?method=deleteAdmin&page=1'>下一页</a>|<a href='${pageContext.request.contextPath}/pages/admins/index.do?method=deleteAdmin&page=1'>最后一页</a>|</td>
	</tr>
</table>
