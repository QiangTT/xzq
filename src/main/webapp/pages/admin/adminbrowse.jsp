	...
	<tr>
		...
		<table border='0' cellspacing='0' cellpadding='0'>
			<tr>
				...
				<img src="${pageContext.request.contextPath}/pages/images/sy_2_18.jpg" border="0">
				<a href='${pageContext.request.contextPath}/pages/admin/adminbrowse.jsp' class=channel_title>管理员浏览</a>
				</td>
			</tr>
		</table>
		</td>
...
<<<<<<< .mine
		...
		<form name="admincondform" method="post" action="../admin/adminbrowse.jsp">
=======
		<td align="left" height='31' background='${pageContext.request.contextPath}/pages/images/ctitle_bak_fcenter.jpg'>
		<form name="admincondform" method="post" action="${pageContext.request.contextPath}/pages/admin/adminbrowse.jsp">
>>>>>>> .r9
			查询条件：&nbsp;&nbsp;
			...
			-<input type="text" name="dateto" maxlength="20" value="2008-12-12 12:32:56" style="WIDTH: 60px">
	...
	<tr width="100%"  height="20px">
		<!-- 显示分页导航 -->
		<td>第1页/共1页&nbsp;&nbsp;<a href='${pageContext.request.contextPath}/pages/admins/index.do?method=browseAdmin&page=1'>|第一页</a>|<a href='${pageContext.request.contextPath}/pages/admins/index.do?method=browseAdmin&page=1'>上一页</a>|<a href='${pageContext.request.contextPath}/pages/admins/index.do?method=browseAdmin&page=1'>下一页</a>|<a href='${pageContext.request.contextPath}/pages/admins/index.do?method=browseAdmin&page=1'>最后一页</a>|</td>
	</tr>
</table>
